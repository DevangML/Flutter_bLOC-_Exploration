class GroceryData {
  static List<Map<String, dynamic>> groceryProducts = [
    ...
    },
    {
      ...
      'price': 1.99,
      'imageUrl':
          'https://cdn.shopify.com/s/files/1/1575/0603/products/download_3917b4f6-faf0-4662-a627-085298548310.jpg?v=1678191797',
    },
    {
      'id': '3',
      'name': 'Bread',
    ...
    },
    {
      ...
      'price': 3.99,
      'imageUrl':
          'https://www.greendna.in/cdn/shop/products/Brown-eggs1_1024x1024@2x.jpg?v=1627154548',
    },
  ];
}
